...
- A file link that names a line now opens the file scrolled to that line instead of the top, whether you click it in a transcript or pick a search result.
